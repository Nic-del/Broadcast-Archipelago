                  ...
                  <div className="text-[14px] leading-tight font-medium">
                    {(notif.event === 'receive' || notif.event === 'send') && (
                      <div>
                        ...
                        {showLocations && notif.location && (
                          <p className="text-[11px] text-neutral-400 mt-0.5 flex items-center gap-1">
                            <MapPin className="w-3 h-3 text-neutral-500" />
                            at <span className="text-white font-medium">{notif.location}</span>
                          </p>
                        )}
                      </div>
                    )}
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-4 bg-white/5 p-3 rounded-xl border border-white/5">
                        <div className="space-y-3">
                          ...
                          <div className="flex justify-between items-center pt-3 border-t border-white/5">
                            <div className="flex flex-col">
                              <span className="text-[10px] font-bold uppercase tracking-wider text-pink-500">Display Locations</span>
                              <span className="text-[8px] text-neutral-500 lowercase italic">Show item locations in notifications</span>
                            </div>
                            <button 
                              onClick={() => {
                              ...
                              className={cn(
                                "w-8 h-4 rounded-full relative transition-colors duration-200",
                                showLocations ? "bg-pink-500" : "bg-neutral-800"
                              )}
                            >
                              <div className={cn(
                                "absolute top-0.5 w-3 h-3 bg-white rounded-full transition-all duration-200",
